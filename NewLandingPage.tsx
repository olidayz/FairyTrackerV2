...
const NewLandingPage = () => {
    ...
    const handleEnter = async () => {
        ...
        try {
            ...
            const data = await response.json();
            navigate(`/tracker/${data.trackerToken}`);
        } catch (err: any) {
                    ...
                    <div className="container mx-auto max-w-6xl">
                        ...
                        <div className="grid lg:grid-cols-[1.3fr_1fr] gap-12 lg:gap-20 items-center">
                            ...
                            <div className="relative flex justify-center items-center min-h-[580px]">
                                ...
                                <div id="signup-form" className="relative w-full max-w-lg bg-slate-950 rounded-[2rem] p-10 shadow-[0_30px_80px_rgba(0,0,0,0.6)] border-2 border-white/10 z-10">
                                    {/* Glow Ring */}
                                    ...
                                    <div className="relative z-10 space-y-8">
                                        ...
                                        {formError && (
                                            <div className="text-red-400 text-sm text-center font-medium">{formError}</div>
                                        )}
