...
const Footer = () => {
    return (
        <footer className="relative py-6 md:py-16 px-4 border-t border-white/10">
            {/* Background Glow */}
            ...
            <div className="container mx-auto max-w-6xl relative z-10">
                ...
                <div className="md:hidden">
                    ...
                    <div className="flex items-center justify-center gap-3 mb-4">
                        <img src="/kiki-logo.png" alt="Kiki" className="w-10 h-10 rounded-lg shadow-lg" />
                        <a
                            href="https://www.instagram.com/kikithetoothfairy/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="w-8 h-8 rounded-lg bg-gradient-to-br from-fuchsia-500 to-purple-600 flex items-center justify-center hover:scale-110 transition-transform shadow-lg"
                        >
                    ...
                    {/* Inline Links */}
                    <div className="flex flex-wrap justify-center gap-x-4 gap-y-1 mb-3 text-[11px]">
                    ...
                    {/* Copyright */}
                    <p className="text-slate-500 text-[10px] text-center">© {new Date().getFullYear()} Tooth Fairy Tracker</p>
                </div>
