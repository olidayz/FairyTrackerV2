...
const ToothTargetWidget = ({ userName }: { userName: string }) => (
  <div className="w-full h-full relative flex items-center justify-center overflow-hidden bg-cyan-950/20">
    ...
    <div className="absolute bottom-2 w-full text-center z-40">
      <span className="font-sans text-[10px] font-bold text-cyan-200 tracking-wider uppercase drop-shadow-md">{userName}'s Tooth</span>
    </div>
  </div>
);
...
const FunPhaseDivider = ({
  ...
  <div className={`relative py-4 md:py-6 group ${className}`}>
    ...
    <div className="relative flex flex-col items-center justify-center z-10 px-4 text-center">
      ...
      {/* ROW 2: MAIN TITLE */}
      <h2 className="font-chrome text-4xl md:text-7xl text-white uppercase tracking-normal leading-normal drop-shadow-[0_4px_0_rgba(0,0,0,1)] scale-y-110 py-2 md:py-4 whitespace-nowrap">
...
const MissionHeaderCard = ({ userName }: { userName: string }) => (
  <div className="relative w-full flex flex-col items-center justify-center mb-10 pt-8 pb-4">
    ...
    <div className="relative z-10 flex flex-col items-center text-center w-full max-w-4xl mx-auto">
      ...
      <div className="relative flex flex-col items-center">
        ...
        {/* Dynamic User Name - Main name with scan line */}
...
const StartMissionCard = ({ onClick, userName }: { onClick?: () => void; userName: string }) => (
        ...
        <div className="w-full flex justify-center md:w-auto md:inline-flex mb-3">
          <div className="inline-flex items-center px-4 py-1.5 rounded-full bg-slate-900 border border-slate-700 shadow-lg group-hover:border-slate-500 transition-colors">
            <span className="font-sans text-[10px] md:text-xs text-cyan-400 font-bold tracking-widest uppercase">
              {userName.toUpperCase()}'S MISSION
            </span>
          </div>
        </div>
...
function Tracker() {
  ...
  // Redirect to home if no token provided (but not if in iframe)
  useEffect(() => {
  ...
  // Fetch tracker data when token is available
  useEffect(() => {
    const fetchTrackerData = async () => {
      ...
      try {
        ...
        setError('Unable to load tracker. Please check your link.');
      } finally {
        setLoading(false);
      }
    };
    ...
    return (
      <div className="min-h-screen bg-[#02040a] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-cyan-400 font-sans text-lg">Loading your fairy tracker...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen bg-[#02040a] flex items-center justify-center px-4">
        <div className="text-center bg-slate-900 border border-red-500/30 rounded-2xl p-8 max-w-md">
          ...
          <a href="/" className="inline-block px-6 py-3 bg-cyan-500 text-black font-bold rounded-lg hover:bg-cyan-400 transition">
            Go Home
          </a>
        </div>
      </div>
  ...
  return (
    <div className="min-h-screen bg-[#02040a] text-white font-sans selection:bg-cyan-500/30 pb-20 overflow-x-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 py-4 md:py-8 max-w-5xl">
        ...
        {/* 1. HEADER SECTION */}
        <MissionHeaderCard userName={userName} />

        {/* 2. ISOLATED START CARD */}
        <StartMissionCard onClick={unlockNextBatch} userName={userName} />
