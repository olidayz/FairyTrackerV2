                ...
                < section className="relative py-16 px-4" >
                    <div className="container mx-auto max-w-6xl">
                        ...
                        <div className="relative">
                            ...
                            <div id="signup-form" className="lg:absolute lg:-left-4 lg:top-1/2 lg:-translate-y-1/2 mt-8 lg:mt-0 w-full max-w-lg mx-auto lg:mx-0 z-20">
                                    ...
                                    <div className="bg-[#0a0e1a] rounded-[1.4rem] p-6 md:p-10">
                                        ...
                                        <div className="space-y-4">
                                            ...
                                            >
                                                {/* Shine Sweep Effect */}
                                                <div className="absolute inset-x-0 top-0 h-full w-20 bg-white/20 -skew-x-12 -translate-x-full group-hover/btn:animate-[shimmer_1.5s_infinite]" />
                                                <span className="relative z-10">{isSubmitting ? 'Starting...' : 'Start Tracking ✨'}</span>
                                            </button>
